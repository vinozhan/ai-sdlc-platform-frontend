  ...
  return (
    <>
      <div className="mx-auto max-w-2xl text-center">
        ...
        <h1
          className={cn(
            "text-[1.65rem] font-semibold leading-tight tracking-tight sm:text-3xl md:text-4xl",
            isDark ? "text-white" : "text-slate-900"
          )}
        >
          Hi {firstName}, what do you want to build?
        </h1>
        <p className={cn("mx-auto mt-3 max-w-md text-sm md:text-base", isDark ? "text-slate-400" : "text-slate-500")}>
      ...
      <div
        className={cn(
          "mx-auto mt-6 w-full max-w-2xl rounded-2xl border border-transparent p-3 shadow-lg transition-all focus-within:shadow-xl sm:mt-8 sm:p-4",
          isDark
