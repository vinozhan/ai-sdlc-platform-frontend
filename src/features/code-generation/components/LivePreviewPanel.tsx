...
export function LivePreviewPanel({
  ...
  return (
    <div className={cn("flex h-full flex-col overflow-hidden rounded-xl border", surface.panel(isDark))}>
      <div className={cn("border-b px-4 py-3", surface.divider(isDark))}>
        <h3 className={cn("text-sm font-semibold", surface.heading(isDark))}>Live Preview</h3>
      </div>
