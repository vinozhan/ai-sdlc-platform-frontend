...
import { Card, CardContent, CardHeader, CardTitle, CodeBlock } from "@/shared/ui/primitives";
import { MermaidDiagram } from "@/shared/viz";
import { umlDiagramList, type UMLDiagramDefinition } from "../fixtures/umlDiagrams";
...
export function UMLDiagramModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-8">
      ...
      >
        <div className={cn("flex items-start justify-between gap-4 border-b px-6 py-4", surface.divider(isDark))}>
          <div>
